...
// Activity OAuth2 token exchange
try { const activity = require('./activity'); app.use('/activity', activity); } catch(e) { console.warn('[API] activity route not loaded:', e.message); }
...
app.get('/health', (_, res) => res.json({
  status:'ok', service:'conbot5-api', version:'5.0.0',
  guilds: roomStates.size, ts: new Date().toISOString(),
}));
